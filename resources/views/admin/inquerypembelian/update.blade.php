            ...
            <div class="card-body">
                ...
                <div class="form-group" hidden>
                    ...
                    <input type="text" class="form-control" id="marketing_id" name="marketing_id" placeholder=""
                        value="{{ old('marketing_id', $pembelian->marketing->id) }}">
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kode_marketing" name="kode_marketing" readonly
                        placeholder="" value="{{ old('kode_marketing', $pembelian->marketing->kode_marketing) }}">
                </div>
                <div class="form-group">
                    <label for="umur">Umur</label>
                    <input type="text" class="form-control" id="umur_marketing" name="umur" placeholder="" readonly
                        value="{{ old('umur', $pembelian->marketing->umur) }}">
                </div>
                <div class="form-group">
                    <label for="alamat">Alamat</label>
                    <textarea type="text" class="form-control" id="alamat_marketing" name="alamat" readonly placeholder="">{{ old('alamat', $pembelian->marketing->alamat) }}</textarea>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="telp_marketing" name="telp" class="form-control" readonly
                            placeholder="" value="{{ old('telp', $pembelian->marketing->telp) }}">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('no_mesin') is-invalid @enderror" id="no_mesin" name="no_mesin"
                        type="text" placeholder="masukan no mesin"
