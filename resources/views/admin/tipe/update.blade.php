...
<div class="card">
  ...
  <form action="{{ url('admin/tipe/' . $tipe->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
    @csrf
    @method('put')
    <div class="card-body">
      <div class="mb-3">
        <label class="form-label" for="nama_tipe">Nama Tipe *</label>
        <input class="form-control" id="nama_tipe" name="nama_tipe" type="text" placeholder="masukan nama tipe"
