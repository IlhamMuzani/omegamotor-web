            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('kode_pembelian') is-invalid @enderror" id="penjualan_id"
                        name="penjualan_id" readonly type="text" placeholder=""
                        value="{{ old('penjualan_id', $komisis->penjualan_id) }}" />
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('kendaraan_id') is-invalid @enderror" id="kendaraan_id"
                        ...
                        value="{{ old('kendaraan_id', $komisis->kendaraan->id) }}" />
                </div>
                <div class="mb-3">
                    ...
                    <input class="form-control @error('no_pol') is-invalid @enderror" id="kendaraan" name="no_pol"
                        ...
                        value="{{ old('no_pol', $komisis->kendaraan->no_pol) }}" />
                </div>
                <div class="mb-3">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_marketing" readonly name="nama_marketing"
                        placeholder="" value="{{ old('nama_marketing', $komisis->marketing->nama_marketing) }}">
                </div>
                <div class="mb-3">
