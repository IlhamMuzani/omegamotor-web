...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5>Perbarui Komisi</h5>
        </div>
        <form action="{{ url('admin/inquery_komisi/' . $komisis->id) }}" method="POST" enctype="multipart/form-data"
            autocomplete="off">
            @csrf
            @method('put')
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <select class="form-control" id="kategori" name="kategori" onchange="showCategoryModal(this.value)">
                        ...
                        <option value="Pembelian"
                            {{ old('kategori', $komisis->kategori) == 'Pembelian' ? 'selected' : null }}>
                            Pembelian</option>
                        <option value="Penjualan"
                            {{ old('kategori', $komisis->kategori) == 'Penjualan' ? 'selected' : null }}>
                            Penjualan</option>
                    </select>
                </div>
                {{-- <div class="mb-3 mt-4">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('kode_pembelian') is-invalid @enderror" id="pembelian_id"
                        name="pembelian_id" readonly type="text" placeholder=""
                        value="{{ old('pembelian_id', $komisis->pembelian_id) }}" />
                </div>
                <div class="mb-3">
                    ...
                    <input class="form-control @error('kode') is-invalid @enderror" id="kode" name="kode_faktur"
                        readonly type="text" placeholder="" value="{{ old('kode_faktur', $komisis->kode_faktur) }}" />
                </div>
                <div class="mb-3" hidden>
                    ...
                    <input class="form-control @error('pelanggan_id') is-invalid @enderror" id="pelanggan_id"
                        name="pelanggan_id" readonly type="text" placeholder=""
                        value="{{ old('pelanggan_id', $komisis->pelanggan_id) }}" />
                </div>
                <div class="mb-3">
                    ...
                    <input class="form-control @error('nama_pelanggan') is-invalid @enderror" id="nama_pelanggan"
                        name="nama_pelanggan" readonly type="text" placeholder=""
                        value="{{ old('nama_pelanggan', $komisis->pelanggan->nama_pelanggan) }}" />
                </div>
                <div class="mb-3" hidden>
                    ...
                    <input class="form-control @error('kendaraan_id') is-invalid @enderror" id="kendaraan_id"
                        ...
                        value="{{ old('kendaraan_id', $komisis->kendaraan->kendaraan_id) }}" />
                </div>
                <div class="mb-3">
                    ...
                    <input class="form-control @error('no_pol') is-invalid @enderror" id="kendaraan" name="no_pol" readonly
                        type="text" placeholder="" value="{{ old('no_pol', $komisis->kendaraan->no_pol) }}" />
                </div>
                <div class="mb-3">
                    <label class="form-label" for="harga">Harga *</label>
                    <input class="form-control @error('harga') is-invalid @enderror" id="harga" name="harga"
                        readonly type="text" placeholder="" value="{{ old('harga', $komisis->harga) }}" />
                </div>
                <div class="mb-3">
                ...
                <div class="mb-2 d-flex">
                    <input class="form-control @error('nama_marketing') is-invalid @enderror" id="nama_marketing"
                        name="no_pol" type="text" placeholder=" " value="{{ old('nama_marketing', $komisis->marketing->kode_marketing) }}" readonly
                ...
                <div class="form-group"hidden>
                    ...
                    <input type="text" class="form-control" id="marketing_id" name="marketing_id" placeholder=""
                        value="{{ old('marketing_id', $komisis->marketing->id) }}">
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kode_marketing" name="kode_marketing" readonly
                        placeholder="" value="{{ old('kode_marketing', $komisis->marketing->kode_marketing) }}">
                </div>
                <div class="form-group">
                    <label for="umur">Umur</label>
                    <input type="text" class="form-control" id="umur" name="umur" placeholder="" readonly
                        value="{{ old('umur', $komisis->marketing->umur) }}">
                </div>
                <div class="form-group">
                    <label for="alamat">Alamat</label>
                    <textarea type="text" class="form-control" id="alamat" name="alamat" readonly placeholder="">{{ old('alamat', $komisis->marketing->alamat) }}</textarea>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="telp" name="telp" class="form-control" readonly
                            placeholder="" value="{{ old('telp', $komisis->marketing->telp) }}">
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <input class="form-control @error('fee') is-invalid @enderror" id="fee" name="fee"
                        type="text" placeholder="masukan fee" value="{{ old('fee', $komisis->fee) }}" />
                </div>
                                ...
                                <tbody>
                                    @foreach ($pembelians as $pembelian)
                                        <tr>
                                            ...
                                            <td>{{ $pembelian->detail_kendaraan->first()->no_pol }}</td>
                                ...
                                <tbody>
                                    @foreach ($penjualans as $penjualan)
                                        <tr>
                                            ...
                                            <td>{{ $penjualan->kendaraan->no_pol }}</td>
