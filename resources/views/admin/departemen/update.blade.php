...
<div class="card">
  <div class="card-header">
    <h5>Perbarui departemen</h5>
  </div>
  <form action="{{ url('admin/departemen/' . $departemen->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
    @csrf
    @method('put')
    <div class="card-body">
      <div class="mb-3">
        <label class="form-label" for="nama">Nama Departemen *</label>
