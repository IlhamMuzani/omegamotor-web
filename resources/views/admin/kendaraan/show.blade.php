            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    @if ($kendaraan->gambar_depan)
                        <img src="{{ asset('storage/uploads/' . $kendaraan->gambar_depan) }}" alt="{{ $kendaraan->no_pol }}"
                            height="130" width="100" class="w-100 rounded border">
                    @else
                    ...
                    @if ($kendaraan->gambar_kanan)
                        <img src="{{ asset('storage/uploads/' . $kendaraan->gambar_kanan) }}" alt="{{ $kendaraan->no_pol }}"
                            height="130" width="100" class="w-100 rounded border">
                    @else
                        <img class="mt-3" src="{{ asset('storage/uploads/gambaricon/imagenoimage.jpg') }}"
                            alt="AdminLTELogo" height="100" width="200">
