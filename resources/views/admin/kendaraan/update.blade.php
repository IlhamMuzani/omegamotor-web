        ...
        <form action="{{ url('admin/kendaraan/' . $kendaraan->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="card-body">
                ...
                <div class="mb-3" hidden>
                    ...
                    @else
                        <input class="form-control @error('merek_id') is-invalid @enderror" id="merek_id"
                            name="merek_id" readonly type="text" placeholder="" value="Merek Tidak Tersedia" />
                    @endif
                </div>
                <div class="mb-3">
                    ...
                    <input class="form-control @error('nama_merek') is-invalid @enderror" id="nama_merek"
                        ...
                        value="{{ old('nama_merek', $kendaraan->merek->nama_merek ?? 'Data Tidak Tersedia') }}" />
                </div>
                <div class="mb-3">
                    <label class="form-label" for="model">Model *</label>
                    <input class="form-control @error('model') is-invalid @enderror" id="model" name="model"
                        readonly type="text" placeholder=""
                        value="{{ old('model', $kendaraan->merek->modelken->nama_model ?? 'Data Tidak Tersedia') }}" />
                </div>
                <div class="mb-3">
                    <label class="form-label" for="tipe">Tipe *</label>
                    <input class="form-control @error('tipe') is-invalid @enderror" id="tipe" name="tipe"
                        readonly type="text" placeholder=""
                        value="{{ old('tipe', $kendaraan->merek->tipe->nama_tipe ?? 'Data Tidak Tersedia') }}" />
                </div>
