                            ...
                            <div class="card">
                                @if (session('success'))
                                    <div class="alert alert-primary alert-dismissible" user="alert">
                                        {{ session('success') }}
                                        <button class="btn-close float-end" type="button" data-bs-dismiss="alert"
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <form method="POST" action="{{ url('login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control @error('kode_user') is-invalid @enderror"
                                                name="kode_user" id="kode_user" type="kode_user"
                                                value="{{ old('kode_user') }}" />
                                            @error('kode_user')
